      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow-sm rounded-lg p-8">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p className="mb-4">
              If you have any questions about these Terms, please contact us at: <a href="mailto:legal@agenticmechanic.com" className="text-blue-600 hover:text-blue-800">legal@agenticmechanic.com</a>
            </p>
          </div>
        </div>
      </div>
