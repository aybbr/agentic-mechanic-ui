...
export const metadata: Metadata = {
  title: "Login | Agentic Mechanic",
  description: "Log in to your Agentic Mechanic account",
};
      ...
      <div className="w-full max-w-md px-4 z-10 animate-fade-in">
        <div className="bg-white/80 backdrop-blur-md shadow-xl rounded-2xl border border-white/20 overflow-hidden animate-float">
          <div className="px-8 py-6 bg-gradient-to-r from-green-600 to-emerald-600 text-white">
            <h1 className="text-2xl font-bold animate-fade-in animation-delay-100">Welcome back</h1>
            <p className="text-green-100 mt-1 animate-fade-in animation-delay-200">Log in to your account</p>
          </div>
