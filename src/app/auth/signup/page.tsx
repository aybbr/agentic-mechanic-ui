...
export default function SignupPage() {
  return (
    <div className="min-h-screen relative flex flex-col items-center justify-center">
      ...
      {/* Decorative elements */}
      <div className="absolute top-1/4 -left-20 w-72 h-72 bg-indigo-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
      <div className="absolute bottom-1/4 -right-20 w-72 h-72 bg-purple-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
      <div className="absolute bottom-1/3 left-1/3 w-60 h-60 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
      ...
      <div className="w-full max-w-md px-4 z-10 animate-fade-in">
        <div className="bg-white/80 backdrop-blur-md shadow-xl rounded-2xl border border-white/20 overflow-hidden animate-float">
          <div className="px-8 py-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
            ...
            <p className="text-indigo-100 mt-1 animate-fade-in animation-delay-200">Join Agentic Mechanic today</p>
          </div>
