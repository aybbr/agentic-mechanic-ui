...
export function WaitlistModal({ isOpen, onClose }: WaitlistModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="min-h-[100dvh] md:min-h-0 flex items-center justify-center w-full py-6">
        <div
          ref={modalRef}
          className="bg-white rounded-2xl shadow-xl max-w-lg w-full relative max-h-full"
        >
          <button
            onClick={onClose}
          ...
          {isSuccess ? (
            ...
            <div className="max-h-[calc(100dvh-3rem)] md:max-h-[80vh] overflow-y-auto">
